...
Usage: 
    combined_script.py [-h] --preservica_folder_ref --metadata_csv METADATA_CSV [--algorithm ALGORITHM]
...
def retrieve_metadata_and_checksums(client, descendants, csv_writer, csv_header, algorithm):
...
def main():
    ...
    with open(args.metadata_csv, 'w', encoding='UTF8', newline='') as metadata_csv_file:
        ...
        retrieve_metadata_and_checksums(
            client, descendants, csv_writer, csv_header, args.algorithm)
